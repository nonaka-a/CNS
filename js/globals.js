...
const buildingTopImg = new Image(); // 新規追加
buildingTopImg.src = 'images/Building_top.png'; // 新規追加
const buildingWallImg = new Image(); // 新規追加
buildingWallImg.src = 'images/Building_Wall.png'; // 新規追加
const lightImg = new Image(); // 追加
lightImg.src = 'images/light.png'; // 追加
const streetlightImg = new Image(); // 追加
streetlightImg.src = 'images/Streetlight.png'; // 追加
const streetlightFrontImg = new Image(); // 新規追加
streetlightFrontImg.src = 'images/Streetlight_front.png'; // 新規追加
const vignetteImg = new Image();
vignetteImg.src = 'images/vignette.png';
const vignette2Img = new Image(); // 新規追加
vignette2Img.src = 'images/vignette2.png'; // 新規追加
let bgX = 0;
let isSoundOn = true;
let canShoot = true;
let isPaused = false;
